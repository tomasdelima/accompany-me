ActiveRecord::Base.transaction do
  user = User.create(email: 'tomasdelima@gmail.com', password: '12345678', password_confirmation: '12345678')
  ...
  (1..10).each do |n|
    friend = Friend.create(email: "tomasdelima+friend_#{n}@gmail.com")
